...
echo "========================================================"
echo " ⚡ HOMEBRIDGE UXC MASTER INITIALIZATION ENGINE (v5) ⚡"
echo "========================================================"
printf '\n\n\n'
...
# Auto-generated by Homebridge UXC Master Initialization Engine (v5)
...
# Split 2: Dynamic Environment Variable Matrix (TZ, PATH, Node globals, mDNS, Memory, Threads, IP)
apply_jq "Runtime Environment Matrix" \
    ...
    '(.process.env = (.process.env 
        | map(select(
            ...
            startswith("HOMEBRIDGE_IP=") or
            startswith("PATH=") or
            startswith("NPM_CONFIG_PREFIX=") or
            startswith("NODE_PATH=") or
            startswith("NPM_CONFIG_CACHE=") or
            startswith("NPM_CONFIG_DEVDIR=") or
            startswith("XDG_CONFIG_HOME=") | not
          )) 
        + [
